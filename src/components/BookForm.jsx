...
const BookForm = ({  returnPromesa }) => {
  ...
  return (
    <>
      <h2 className="text-xl mb-6 font-bold">Publica tu libro favorito</h2>
        ...
        {({ isSubmitting, errors, touched }) => (
          <Form>
            ...
            <button type="submit" disabled={isSubmitting}
              className="w-full flex justify-center py-2 px-4 my-3 border border-gray-600 rounded-md shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus: ring-blue-600"
            >
              Enviar
            </button>
          </Form>
