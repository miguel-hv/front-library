    ...
    return (
        <div>
            ...
            <div className="text-sm">
                <p className="mb-2">
                    Este proyecto es una pequeña demostración con React para el front, Node para el back y Tailwind para la maquetación CSS. La web está adaptada para escritorio y móvil, aunque no está completamente optimizada.
                </p>
                <p className="mb-2">
